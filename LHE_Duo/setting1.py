...
SL_LR = 0.001
BATCH_SIZE = 256
TARGET_POLICY_UPDATE_INTERVAL = 2500
ANTICIPATORY_PARAM = 0.1
EPS = 0.15
EPS_DECAY = 3_000_000

target_network_sizes = [512, 256, 512, 256]

agent0 = NFSP_Agent(2300, target_network_sizes, SAVE_INTERVAL, MRL_SIZE, MSL_SIZE, RL_LR, SL_LR, BATCH_SIZE, TARGET_POLICY_UPDATE_INTERVAL, 
                    ANTICIPATORY_PARAM, EPS, EPS_DECAY, None, LEARN=True)
player0 = Player(id=2300, agent=agent0)

agent1 = NFSP_Agent(2301, target_network_sizes, SAVE_INTERVAL, MRL_SIZE, MSL_SIZE, RL_LR, SL_LR, BATCH_SIZE, TARGET_POLICY_UPDATE_INTERVAL, 
                    ANTICIPATORY_PARAM, EPS, EPS_DECAY, None, LEARN=True)

...
EPS = 0.00
EPS_DECAY=1
MODEL_TO_LOAD = "Agents/NFSP_Model/id=2301_steps=500000"

agent0 = Call_Agent()
player0 = Player(id='Call_Agent', agent=agent0)

network_sizes = [512, 256, 512, 256]
agent1 = NFSP_Agent('NFSP_Agent', network_sizes, SAVE_INTERVAL, MRL_SIZE, MSL_SIZE, RL_LR, SL_LR, BATCH_SIZE, TARGET_POLICY_UPDATE_INTERVAL, ANTICIPATORY_PARAM, EPS, EPS_DECAY, MODEL_TO_LOAD, LEARN=False)

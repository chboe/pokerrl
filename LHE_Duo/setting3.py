...
MODEL_TO_LOAD1 = "Agents/NFSP_Model/id=901_steps=500000_avg.model"
...
agent1 = NFSP_Agent(1, SAVE_INTERVAL, MRL_SIZE, MSL_SIZE, RL_LR, SL_LR, BATCH_SIZE, TARGET_POLICY_UPDATE_INTERVAL, ANTICIPATORY_PARAM, EPS, MODEL_TO_LOAD1, LEARN=False)
